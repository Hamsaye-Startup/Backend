...
public class UserDetailProducerService {

    private static final String DEFAULT_TOPIC = "topic-general-user-details";
     ...
     *
     * @param payload the {@link UserDetailNotifyRequest} to be sent as a Kafka message.
     * @since 1.0
     */
    public void send(@Payload UserDetailNotifyRequest payload) {
        ...
        Message<UserDetailNotifyRequest> message = generateMessage(payload, kafkaHeaders);
     ...
     * @since 1.0
     */
    private Message<UserDetailNotifyRequest> generateMessage(
            UserDetailNotifyRequest payload,
