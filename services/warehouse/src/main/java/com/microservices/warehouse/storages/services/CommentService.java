...
public class CommentService {
     ...
     * @throws CustomJpaPersistanceException If there is an error during the insertion process.
     * @since 1.0
     */
     ...
     * @throws CustomJpaPersistanceException If there is an error during the update process.
     * @since 1.0
     */
     ...
     * @throws CustomNotFoundException If the comment with the specified ID is not found.
     * @since 1.0
     */
    public CommentEntity findCommentById(Long commentId) {
        return commentRepository.findById(commentId)
                .orElseThrow(() -> new CustomNotFoundException("comment [" + commentId + "] is not exist"));
    }
