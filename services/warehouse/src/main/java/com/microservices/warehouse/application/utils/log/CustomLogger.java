package com.microservices.warehouse.application.utils.log;
...
public class CustomLogger {
    ...
    public void info(String message) {
        System.out.printf("\n%s [%s] : %s%n", LocalDateTime.now(ZoneId.systemDefault()), "INFO", message);
    }
    ...
    public void debug(String message) {
        System.out.printf("\n%s [%s] : %s%n", LocalDateTime.now(ZoneId.systemDefault()), "DEBUG", message);
    }
    ...
    public void warn(String message) {
        System.out.printf("\n%s [%s] : %s%n", LocalDateTime.now(ZoneId.systemDefault()), "WARN", message);
    }
    ...
    public void error(String message) {
        System.err.printf("\n%s [%s] : %s%n", LocalDateTime.now(ZoneId.systemDefault()), "ERROR", message);
    }
    ...
    public void error(String message, Throwable cause) {
        System.err.printf("\n%s [%s] : %s%n", LocalDateTime.now(ZoneId.systemDefault()), "ERROR", message);
        if (cause != null) {
            System.err.printf("cause: %s%n", cause.getMessage());
        }
    }
}
